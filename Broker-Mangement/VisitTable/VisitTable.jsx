...
const VisitTable = (params, onClose) => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    { headerName: "VISITE ID", field: "_id" },
    { headerName: "PROPERTY NAME", field: "propertyName", filter: true },
    { headerName: "ADDRESS", field: "address" },
    { headerName: "PRICE", field: "", filter: true },
    { headerName: "UNIT TYPE", field: "typeOfProperty", filter: true },
  ]);
    ...
    const AllVisit = async () => {
      try {
        const response = await axios.get(
          "http://nestobackend-env.eba-fk3zufmz.ap-south-1.elasticbeanstalk.com/api/v1/visit/getVisitById?id=" +
            `${selectedRowId}`,
          {
            headers: {
              authorization:
